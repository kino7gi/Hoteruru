package com.example.samuraitrabel.controller; // 適切なパッケージ名に合わせてください

import org.springframework.data.domain.Page;
import org.springframework.data.domain.Pageable;
import org.springframework.data.domain.Sort.Direction; // これが必要
...
import com.example.samuraitrabel.service.HouseService;
...
public class AdminHouseController {
    ...
    public String show(@PathVariable(name = "id") Integer id, Model model) {
        // getReferenceByIdよりfindById().orElseThrow()の方が安全な場合が多いです
        House house = houseRepository.findById(id).orElseThrow(() -> new RuntimeException("民宿が見つかりません"));
